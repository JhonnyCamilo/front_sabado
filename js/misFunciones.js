...
function traerInformacionFincas(){
    $.ajax({
        url:"http://132.226.167.94:8080/api/Farm/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionFincas(){
    let var2 = {
        ...
        url:"http://132.226.167.94:8080/api/Farm/save",
...
function actualizarInformacionFinca(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.167.94:8080/api/Farm/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarFinca(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.167.94:8080/api/Farm/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
